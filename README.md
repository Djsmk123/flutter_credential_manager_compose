...
![Web](https://img.shields.io/badge/Platforms-Web-orange)
...
For iOS, it uses [Keychain](https://developer.apple.com/documentation/security/keychain_services) and [Autofill](https://developer.apple.com/documentation/uikit/text_input/adding_password_autofill_support_to_your_app). On Web, see [`credential_manager_web`](./packages/credential_manager_web/README.md) for setup, including the required `<script>` tag in `web/index.html`.
